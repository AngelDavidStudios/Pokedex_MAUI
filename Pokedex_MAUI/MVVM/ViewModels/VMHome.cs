...
public class VMHome : VMBase, IInitializeAsync
{
    ...
    public ResourceListModel ResourceList { get; private set; }

    public GenerationModel Generation { get; private set; }
    ...
    public VMHome(INavigation navigation, IRestService restService) : base(navigation)
    {
        ...
        SelectFilterWeaknessCommand =
            new Command<WeaknessFilterModel>((type) => ExecuteSelectFilterWeaknessCommand(type));
    ...
    private void LoadFilters()
    {
        ...
        {
            Console.WriteLine("Error en cargar Filtros", ex.Message);
        }
    }
    ...
    private async Task LoadPokemonsAsync()
    {
        ...
        {
            Console.WriteLine("Error en Cargar Pokemones Async", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteLoadMorePokemonsCommand()
    {
        ...
        {
            Console.WriteLine("Error en ejecutar Mas pokemones", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task GetResourceListAsync(string url)
    {
        ...
        {
            Console.WriteLine("Error en obtener la Lista Resources Async",ex.Message);
        }
    }
    ...
    private async Task<List<PokemonModel>> GetPokemonListAsync()
    {
        ...
        {
            Console.WriteLine("Error en obtener la Lista de Pokemones",ex.Message);
        }
    ...
    private async Task<PokemonModel> GetPokemonAsync(string searchParameter)
    {
        ...
        {
            Console.WriteLine("Error en la obtencion de parametros de busqueda", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task GetGenerationAsync(string url)
    {
        ...
        {
            Console.WriteLine("Error en obtener la Generacion", ex.Message);
        }
    }
    ...
    private async Task<IEnumerable<PokemonTypeDefenseModel>> GetPokemonTypeDefensesAsync(PokemonModel pokemon)
    {
        ...
        try
        {
            ...
            {
                var damageRelation =
                    await _service.GetResourceByNameAsync<TypeModel>(type.Type.ApiEndpoint, type.Type.Name.ToLower());
        ...
        {
            Console.WriteLine("Error en obtener datos de Tipo Defensa", ex.Message);
        }
    ...
    private async Task ExecuteNavigateToDetailCommand(PokemonModel pokemon)
    {
        ...
        {
            Console.WriteLine("Error en la ejecucion de Detalles pokemon", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteOpenModalGenerationCommand()
    {
        ...
        {
            Console.WriteLine("Error en Abrir el Modal Generacion", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteOpenModalSortCommand()
    {
        ...
        {
            Console.WriteLine("Error en abrir el Modal Sort", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteOpenModalFiltersCommand()
    {
        ...
        {
            Console.WriteLine("Error en abrir Modal de filtros", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteResetFiltersCommand()
    {
        ...
        try
        {
            ...
            Filters.Weaknesses =
                new ObservableRangeCollection<WeaknessFilterModel>(PokemonHelper.GetFilterWeaknesses());
        ...
        {
            Console.WriteLine("Error en resetear Filtros", ex.Message);
        }
        finally
        {
            IsBusy = false;
    ...
    private async Task ExecuteApplyFiltersCommand()
    {
        ...
        {
            Console.WriteLine("Error en aplicar filtros", ex.Message);
        }
        finally
        {
            IsBusy = false;
